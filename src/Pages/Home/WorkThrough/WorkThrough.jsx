    ...
    <Container>
      ...
      <VerticalTimeline>
        ...
        >
          ...
          <p>
            Here you will find a straightforward and user-friendly registration
            process designed to get you started on our platform quickly and
            efficiently.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <p>
            We make it easy for you to get your tasks on our platform. Uploading
            Tasks is a breeze, and you can provide Task Details to ensure
            precise evaluation and optimal results.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            Discover versatile Payment Options tailored to your preferences. Our
            Billing and Compensation process ensures accurate and timely
        ...
        >
          ...
          <p>
            Our dedicated Customer Support team is here to address your queries
            and concerns promptly. Explore a wealth of Assistance and Resources
            to empower your journey on our platform, making your experience as
            smooth as possible.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement />
